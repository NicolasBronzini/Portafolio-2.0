...
function Proyecto() {
    const proyectos = [
        { text: 'Depay', size: 15, image: Depayimg, description: 'Creación de  aplicación web desarrollada en React y NestJS, que utiliza todas las APIs de Web3 disponibles para facilitar las transacciones con criptomonedas. ', link: "https://depayapp.com/" },
